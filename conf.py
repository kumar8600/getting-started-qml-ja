...
# -*- coding: utf-8 -*-
#
# Getting started QML programming Japanese translation documentation build configuration file, created by
...
copyright = '2014, Digia Plc and/or its subsidiary(-ies) and kumar8600'
...
htmlhelp_basename = 'GettingstartedQMLprogrammingJapanesetranslationdoc'
